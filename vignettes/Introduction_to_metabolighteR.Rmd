...
metabolighteR provided easy access to publicly available MetaboLights studies *via* the MetaboLights RESTful API. Only API methods which retrieve data (`GET`) are supported by metabolighteR. 
...
Using a combination of functions, a table fo Study ID, Study Title and Study Technology.
...
fileContents_A <- download_study_file(studies[1], studyFileList$file[1])

head(fileContents_A)

fileContents_B <- download_study_file(studies[1], studyFileList$file[5])
